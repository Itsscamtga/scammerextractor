...
from Extractor.modules.careerwill import career_willl
...
buttons = InlineKeyboardMarkup([
                [
                  InlineKeyboardButton("APPX", callback_data="modes_"),
                ],[InlineKeyboardButton("Classplus", callback_data="classplus_"),
                ],[InlineKeyboardButton("Khansir", callback_data="khan_"),
...
modes_button = [[
                  ...
                  InlineKeyboardButton("Appx", callback_data="manual_"),
                ],[
...
async def handle_callback(_, query):
    ...
    elif query.data=="careerwilll_":
        await career_willl(app, query.message)
